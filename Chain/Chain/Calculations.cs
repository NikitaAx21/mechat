...
namespace Chain
{
	public class Calculations
	{
        ...
        public static Point GetCoord(TransformationMatrix tM, CoordinatesMatrix cM)
        {
            var res = new Point
            {
                X = tM.TransMatrix[0, 0] * cM.Vector[0] + tM.TransMatrix[0, 1] * cM.Vector[1] + tM.TransMatrix[0, 2] * cM.Vector[2],
                Y = tM.TransMatrix[1, 0] * cM.Vector[0] + tM.TransMatrix[1, 1] * cM.Vector[1] + tM.TransMatrix[1, 2] * cM.Vector[2]
            };
            tM.X = res.X;
            tM.Y = res.Y;  
            CoordMas.Add(res);         
